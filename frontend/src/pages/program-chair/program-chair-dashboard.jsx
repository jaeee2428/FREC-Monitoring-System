...
export default function ProgramChairDashboard({ onLogout = () => { } }) {
    ...
    const sidebarIcons = [
        ...
        { icon: RotateIcon, label: "Workflow Guide", onClick: () => showToast("Workflow Guide view coming soon.") },
    ];
    
    const activeSidebarIndex = view === "All Documents" ? 1 : view === "Approvals" ? 2 : 0;

    return (
        <DashboardLayout
            userName="Dr. Jose Santos"
            userInitials="DJ"
            activeTab={activeTab}
            ...
            {view === "All Documents" ? (
                ...
                <>
                    ...
                    <div className="relative mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-[#7a1f2b] to-[#4a1319] px-8 py-6 text-white">
                        <h1 className="!m-0 !text-xl !font-bold !text-white">Welcome, Dr. Jose Santos!</h1>
