...
import { accounts, defaultAccount, isAdminRole, isAdviserRole } from '../data/accounts'
...
function LoginPage({ onSignIn }) {
    ...
    const handleAccountClick = (account) => {
        ...
        if (isAdviserRole(account.role) || isAdminRole(account.role)) {
            onSignIn(account)
        }
    }
        ...
        <div className="login-page">
            <div className="login-shell">
                ...
                <div className="session-note">
                    {isAdviserRole(selectedAccount.role) || isAdminRole(selectedAccount.role)
                        ? `${selectedAccount.role} account selected — click "${selectedAccount.name}" to open the dashboard.`
