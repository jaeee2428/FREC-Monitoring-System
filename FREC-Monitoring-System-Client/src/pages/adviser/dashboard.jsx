...
export default function AdviserDashboard() {
  ...
  const forwardedCount = submissions.filter((s) => s.status === "FORWARDED-FREC").length + 1; // baseline from screenshot
  const disapprovedCount = submissions.filter((s) => s.status === "DISAPPROVED").length + 1; // baseline from screenshot
      ...
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-slate-700">Dr. Elena Reyes</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-8 py-6">
          ...
          <div className="mb-5 flex items-center justify-between">
            ...
            <button className="flex items-center gap-1.5 rounded-lg bg-[#7a1f2b] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#671a24]">
