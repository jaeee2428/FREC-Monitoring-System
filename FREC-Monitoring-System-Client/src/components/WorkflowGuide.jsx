...
const MODES = [
    {
        title: "Mode 1",
        route: "Adviser → FREC → Program Chair → Complete",
        headerColor: "text-[#7a1f2b]",
        steps: [
            { label: "Student", sub: "Submits" },
            { label: "Adviser", sub: "Forward" },
            { label: "FREC", sub: "Verify" },
            { label: "Program Chair", sub: "Approve" },
        ],
    },
    {
        title: "Mode 2",
        route: "Adviser → FREC → Program Chair → Dean → Complete",
        headerColor: "text-[#7a1f2b]",
        steps: [
            { label: "Student", sub: "Submits" },
            { label: "Adviser", sub: "Forward" },
            { label: "FREC", sub: "Verify" },
            { label: "Program Chair", sub: "Forward" },
            { label: "Dean", sub: "Approve" },
        ],
    },
    {
        title: "Mode 3",
        route: "Adviser → FREC → Chair → Dean → FREC → Complete",
        headerColor: "text-[#7a1f2b]",
        steps: [
            { label: "Student", sub: "Submits" },
            { label: "Adviser", sub: "Forward" },
